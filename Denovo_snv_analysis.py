...
#Other software. These are often .jar file.
gatk = ini_dict["GATK"]
...
def create_bash(mode, scriptname, modules, language, arguments = std_arguments, pipeline_path = pipeline_path, output_path = output_path, time = time, log = log, email = email, hold_jid = "", threads = 1):
