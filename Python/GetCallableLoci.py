...
###Select for the "CALLABLE" regions in the <sample>.callableloci.bed files.
...
with open(filelist) as f1:
	...
	for line in f1:
		...
		folder = columns[1]
		family = columns[3] 
		#First checks if the output file already exists. Then checks if the input bed file exists as a flat bed. If not, it checks for a compressed bed file.
